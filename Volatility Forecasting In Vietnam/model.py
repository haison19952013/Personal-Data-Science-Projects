...
from data import EodhdAPI, SQLRepository
...
class GarchModel:
    ...
    def __init__(self,ticker,repo, use_new_data):
        ...
        self.model_directory = settings.regressor_directory

    def wrangle_data(self, n_observations = None):
    ...
    def __clean_prediction(self,prediction):
        ...
        start = prediction.index[0] + pd.DateOffset(1)
    ...
    def dump(self):
        ...
        timestamp = pd.Timestamp.now().date().isoformat()
    ...
    def load(self):
        ...
        pattern = os.path.join(self.model_directory, f"*_{self.ticker}.pkl")
